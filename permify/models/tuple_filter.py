...
class TupleFilter(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entity": EntityFilter.from_dict(obj["entity"]) if obj.get("entity") is not None else None,
            "relation": obj.get("relation"),
            "subject": SubjectFilter.from_dict(obj["subject"]) if obj.get("subject") is not None else None
        })
        return _obj
