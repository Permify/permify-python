...
class TupleFilter(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "entity": EntityFilter.from_dict(obj.get("entity")) if obj.get("entity") is not None else None,
            "relation": obj.get("relation"),
            "subject": SubjectFilter.from_dict(obj.get("subject")) if obj.get("subject") is not None else None
        })
        return _obj
