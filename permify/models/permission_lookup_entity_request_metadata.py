...
class PermissionLookupEntityRequestMetadata(BaseModel):
    """
    ...
    depth: Optional[StrictInt] = Field(default=None, description="Depth of lookup, required, must be greater or equal to 3.")
