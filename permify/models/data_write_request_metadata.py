...
class DataWriteRequestMetadata(BaseModel):
    """
    ...
    """ # noqa: E501
    schema_version: Optional[StrictStr] = Field(default=None, description="schema_version represents the version of the schema for the data being written.")
