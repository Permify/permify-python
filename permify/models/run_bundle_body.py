...
class RunBundleBody(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the bundle to be executed.")
    arguments: Optional[Dict[str, StrictStr]] = Field(default=None, description="Additional key-value pairs for execution arguments.")
