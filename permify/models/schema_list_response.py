...
class SchemaListResponse(BaseModel):
    ...
    schemas: Optional[List[SchemaList]] = None
    ...
    __properties: ClassVar[List[str]] = ["head", "schemas", "continuous_token"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "head": obj.get("head"),
            "schemas": [SchemaList.from_dict(_item) for _item in obj.get("schemas")] if obj.get("schemas") is not None else None,
