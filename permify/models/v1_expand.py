...
class V1Expand(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expand": ExpandTreeNode.from_dict(obj["expand"]) if obj.get("expand") is not None else None,
            "leaf": ExpandLeaf.from_dict(obj["leaf"]) if obj.get("leaf") is not None else None
        })
        return _obj
