...
class DataDeleteBody(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tuple_filter": TupleFilter.from_dict(obj.get("tuple_filter")) if obj.get("tuple_filter") is not None else None,
            "attribute_filter": AttributeFilter.from_dict(obj.get("attribute_filter")) if obj.get("attribute_filter") is not None else None
        })
        return _obj
