...
class Tenant(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the tenant.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the tenant.")
    created_at: Optional[datetime] = Field(default=None, description="The time at which the tenant was created.")
