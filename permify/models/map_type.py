...
class MapType(BaseModel):
    ...
    """ # noqa: E501
    key_type: Optional[V1alpha1Type] = Field(default=None, alias="keyType")
    value_type: Optional[V1alpha1Type] = Field(default=None, alias="valueType")
    __properties: ClassVar[List[str]] = ["keyType", "valueType"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "keyType": V1alpha1Type.from_dict(obj.get("keyType")) if obj.get("keyType") is not None else None,
            "valueType": V1alpha1Type.from_dict(obj.get("valueType")) if obj.get("valueType") is not None else None
        })
        return _obj

from permify.models.v1alpha1_type import V1alpha1Type
# TODO: Rewrite to not use raise_errors
MapType.model_rebuild(raise_errors=False)
