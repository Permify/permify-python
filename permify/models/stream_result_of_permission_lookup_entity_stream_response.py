...
class StreamResultOfPermissionLookupEntityStreamResponse(BaseModel):
    """
    StreamResultOfPermissionLookupEntityStreamResponse
    """ # noqa: E501
    result: Optional[PermissionLookupEntityStreamResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": PermissionLookupEntityStreamResponse.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            "error": Status.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
