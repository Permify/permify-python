...
class PartialWriteBody(BaseModel):
    """
    PartialWriteBody
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "metadata": SchemaPartialWriteRequestMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None,
            "partials": dict(
                (_k, Partials.from_dict(_v))
                for _k, _v in obj.get("partials").items()
            )
