...
class TenantListResponse(BaseModel):
    ...
    """ # noqa: E501
    tenants: Optional[List[Tenant]] = Field(default=None, description="tenants is a list of tenants.")
    ...
    __properties: ClassVar[List[str]] = ["tenants", "continuous_token"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tenants": [Tenant.from_dict(_item) for _item in obj.get("tenants")] if obj.get("tenants") is not None else None,
