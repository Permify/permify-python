...
class SchemaListBody(BaseModel):
    """
    ...
    """ # noqa: E501
    page_size: Optional[StrictInt] = Field(default=None, description="page_size is the number of schemas to be returned in the response. The value should be between 1 and 100.")
    ...
    __properties: ClassVar[List[str]] = ["page_size", "continuous_token"]
