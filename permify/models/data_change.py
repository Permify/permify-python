...
class DataChange(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "tuple": Tuple.from_dict(obj.get("tuple")) if obj.get("tuple") is not None else None,
            "attribute": Attribute.from_dict(obj.get("attribute")) if obj.get("attribute") is not None else None
        })
        return _obj
