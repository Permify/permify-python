...
class Child(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "leaf": Leaf.from_dict(obj.get("leaf")) if obj.get("leaf") is not None else None,
            "rewrite": Rewrite.from_dict(obj.get("rewrite")) if obj.get("rewrite") is not None else None
        })
        return _obj
