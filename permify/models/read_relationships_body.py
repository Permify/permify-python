...
class ReadRelationshipsBody(BaseModel):
    """
    ...
    """ # noqa: E501
    metadata: Optional[RelationshipReadRequestMetadata] = None
    filter: Optional[TupleFilter] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "metadata": RelationshipReadRequestMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None,
            "filter": TupleFilter.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
