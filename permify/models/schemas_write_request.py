...
class SchemasWriteRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="schema is the string representation of the schema to be written.", alias="schema")
