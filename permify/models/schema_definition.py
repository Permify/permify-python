    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.entity_definitions:
            for _key_entity_definitions in self.entity_definitions:
                if self.entity_definitions[_key_entity_definitions]:
                    _field_dict[_key_entity_definitions] = self.entity_definitions[_key_entity_definitions].to_dict()
        ...
        if self.rule_definitions:
            for _key_rule_definitions in self.rule_definitions:
                if self.rule_definitions[_key_rule_definitions]:
                    _field_dict[_key_rule_definitions] = self.rule_definitions[_key_rule_definitions].to_dict()
