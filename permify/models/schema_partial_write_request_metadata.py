...
class SchemaPartialWriteRequestMetadata(BaseModel):
    """
    ...
    """ # noqa: E501
    schema_version: Optional[StrictStr] = Field(default=None, description="schema_version is the string that identifies the version of the schema to be read.")
