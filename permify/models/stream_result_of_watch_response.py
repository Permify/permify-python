...
class StreamResultOfWatchResponse(BaseModel):
    """
    StreamResultOfWatchResponse
    """ # noqa: E501
    result: Optional[WatchResponse] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "result": WatchResponse.from_dict(obj.get("result")) if obj.get("result") is not None else None,
