...
class TenantCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="id is a unique identifier for the tenant.")
    name: Optional[StrictStr] = Field(default=None, description="name is the name of the tenant.")
