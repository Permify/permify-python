...
class DataRelationshipsReadRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": RelationshipReadRequestMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "filter": TupleFilter.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
