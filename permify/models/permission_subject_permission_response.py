...
class PermissionSubjectPermissionResponse(BaseModel):
    """
    PermissionSubjectPermissionResponse is the response message for the SubjectPermission method in the Permission service.
    """ # noqa: E501
    results: Optional[Dict[str, CheckResult]] = Field(default=None, description="Map of results for each permission check.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "results": dict((_k, _v) for _k, _v in obj.get("results").items())
        })
        return _obj
