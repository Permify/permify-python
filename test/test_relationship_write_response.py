...
class TestRelationshipWriteResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RelationshipWriteResponse:
        """Test RelationshipWriteResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationshipWriteResponse`
        """
        model = RelationshipWriteResponse()
        if include_optional:
    ...
    def testRelationshipWriteResponse(self):
        """Test RelationshipWriteResponse"""
