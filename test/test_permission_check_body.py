...
class TestPermissionCheckBody(unittest.TestCase):
    """PermissionCheckBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PermissionCheckBody:
        """Test PermissionCheckBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionCheckBody`
        """
        model = PermissionCheckBody()
        if include_optional:
            return PermissionCheckBody(
    ...
    def testPermissionCheckBody(self):
        """Test PermissionCheckBody"""
