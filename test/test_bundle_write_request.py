...
class TestBundleWriteRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BundleWriteRequest:
        """Test BundleWriteRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BundleWriteRequest`
        """
        model = BundleWriteRequest()
        if include_optional:
    ...
    def testBundleWriteRequest(self):
        """Test BundleWriteRequest"""
