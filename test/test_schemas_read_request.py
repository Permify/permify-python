...
class TestSchemasReadRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SchemasReadRequest:
        """Test SchemasReadRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SchemasReadRequest`
        """
    ...
    def testSchemasReadRequest(self):
        """Test SchemasReadRequest"""
