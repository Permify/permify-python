...
class TestPermissionsLookupSubjectRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PermissionsLookupSubjectRequest:
        """Test PermissionsLookupSubjectRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionsLookupSubjectRequest`
        """
    ...
    def testPermissionsLookupSubjectRequest(self):
        """Test PermissionsLookupSubjectRequest"""
