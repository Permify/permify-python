...
class TestRelationshipDeleteResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RelationshipDeleteResponse:
        """Test RelationshipDeleteResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationshipDeleteResponse`
        """
        model = RelationshipDeleteResponse()
        if include_optional:
    ...
    def testRelationshipDeleteResponse(self):
        """Test RelationshipDeleteResponse"""
